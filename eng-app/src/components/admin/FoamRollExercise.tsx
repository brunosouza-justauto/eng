    ...
    <div className="mb-6 overflow-hidden border rounded-lg shadow dark:bg-gray-750 dark:border-gray-700">
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-700">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 overflow-hidden bg-gray-200 rounded dark:bg-gray-600">
            {/* Use an actual image in a real implementation */}
            <img 
              src="https://via.placeholder.com/32" 
              alt="Foam Roll Brachialis"
              className="object-cover w-full h-full"
            />
          </div>
          <h3 className="font-medium dark:text-white">Foam Roll Brachialis</h3>
        </div>
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2">
                  <input 
                    type="checkbox" 
                    id="each-side-foam-roll"
                    checked={eachSide}
                    onChange={() => setEachSide(!eachSide)}
                    className="text-indigo-600 rounded focus:ring-indigo-500"
                  />
                  <label htmlFor="each-side-foam-roll" className="text-sm text-gray-700 dark:text-gray-300">
                    Each Side
                  </label>
                </div>
                <div className="flex items-center gap-2">
...
export default FoamRollExercise; 